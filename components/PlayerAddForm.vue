<template>
    <div>
        <form class="flex flex-col gap-5" @submit.prevent="onAddPlayer">
            <label for="player"
                   class="relative block overflow-hidden rounded-md border border-gray-700 bg-gray-800 px-3 pt-3 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600">
                <input id="player"
